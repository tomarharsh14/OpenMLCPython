...
def individual_data(indiv):
    ...
    dataset = pd.read_csv('Holiday_Dataset.csv', delimiter='\t')
    x0 = dataset.iloc[:, 0]  # Time
    x1 = dataset.iloc[:, 1]  # Temperature
    x2 = dataset.iloc[:, 2]  # Wind
    x3 = dataset.iloc[:, 3]  # Solar
    x4 = dataset.iloc[:, 4]  # Humidity
    x5 = dataset.iloc[:, 8]  # IsHoliday
    x6 = dataset.iloc[:, 9]  # Day of the Week
    y = dataset.iloc[:, 5]  # Whole Building Energy
    # ==============================================================================
    # ==============================================================================
